      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Conheça quem criou o Protocolo
          </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <h3 className="text-3xl font-bold mb-6">
              <span className="gradient-text">{nutritionist.name}</h3>
              <br />Nutricionista Especialista
            </h3>
            ...
            <div className="space-y-3 mb-8">
              {nutritionist.credentials.map((credential, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="w-2 h-2 bg-primary rounded-full"></p>
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-12">
            Perguntas <span className="gradient-text">Frequentes</h2>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-8">
              Ainda tem <span className="gradient-text">dúvidas?</h2>
            </h2>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <div className="font-semibold">Instagram</p>
