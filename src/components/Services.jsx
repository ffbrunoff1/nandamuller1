      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            O que você <span className="gradient-text">recebe</section>
          </h2>
        ...
        >
          <h3 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Como acontece na <span className="gradient-text">prática</h3>
          </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-20">
          ...
          >
            <h3 className="text-3xl font-bold mb-8">
              Para quem é o <span className="gradient-text">Protocolo</h3>
            </h3>
          ...
          >
            <h3 className="text-3xl font-bold mb-8">
              O que você <span className="gradient-text">conquista</h3>
            </h3>
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-4xl mx-auto">
            ...
            <strong> Garanta agora o seu acesso ao Protocolo Desinchar</p> e em apenas 7 dias retome o equilíbrio do seu corpo.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <p className="text-lg">
              Mais <strong>desinchada</p>, mais <strong>magra</strong>, mais <strong>leve</strong>, saudável e feliz!
            </p>
          </div>
        </motion.div>
